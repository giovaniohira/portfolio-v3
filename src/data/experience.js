...
const experienceData = [
  {
    ...
    shortSummary: 'Mid-Level Software Engineer making architecture and infrastructure calls, delivering client work across web and mobile, and mentoring junior developers on a growing engineering team.',
    ...
    endDate: null,
    isCurrent: true,
    description: 'At Nexus Labz I work as a mid-level engineer on client-facing and internal initiatives, driving technical decisions, supporting junior developers, and shipping end-to-end solutions from web applications to mobile. Client delivery included React Native alongside web stacks as engagements required.',
    functionSummary: 'My role spans engineering leadership and hands-on delivery. On client work I move between web and mobile depending on what each engagement needs, from API design and backend services to frontend and mobile surfaces, including React Native where the stack called for it. Internally, I helped establish the company\'s first production hosting environment: VPS setup, Nginx, SSL/TLS (Let\'s Encrypt), CI/CD with GitHub Actions, and baseline security practices. I make day-to-day architecture and tradeoff decisions, run technical reviews, and mentor a junior developer through code reviews, pairing, and ownership of smaller features.',
    keyResponsibilities: [
      'Delivered client work across web and mobile, adapting stack and scope per engagement.',
      'Drove engineering decisions on architecture, APIs, auth, and deployment strategy.',
      'Stood up the company\'s initial production environment (VPS, Nginx, SSL/TLS, CI/CD).',
      'Implemented secure authentication, API communication, and deployment automation (GitHub Actions).',
      'Mentored a junior developer through reviews, pairing, and gradual feature ownership.',
      'Built and maintained React Native surfaces for clients alongside web deliverables.'
    ],
    impact: 'Helped bootstrap reliable production infrastructure and delivery practices from scratch, while shipping client work across web and mobile and growing the team through structured mentorship.',
    skills: [
      'System Architecture',
